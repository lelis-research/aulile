...
if __name__ == "__main__":
    ...
    seed_list = [1, 2, 3, 4, 5, 1234]

    for seed in seed_list:

        tensorflow.random.set_seed(seed)

        dataFrame = pd.read_csv(data_directory + "random_bustle_encoded_training_data.csv", dtype=np.byte)
        ...
        BustleModel.save(models_directory +"EncodedBustleModelForPS_" + str(seed) + ".hdf5")
