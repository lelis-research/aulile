...
flags.DEFINE_string('task_name', None, 'name of single task to eval')
...
flags.DEFINE_integer('attempts', 1, '# of attempts for each test problem')
flags.DEFINE_bool('grow_library', False, 'try to grow the library after each failed attempt')
flags.DEFINE_bool('stop_if_no_grow', False, 'stop attempts if the library did not grow')
