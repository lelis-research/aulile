...
if __name__ == "__main__":
    ...
    for lk in logkeys:
        ...
        plt.step(x_list, avg_program_solved_against_evals[lk], label='BEE' if lk == 'bee_search' else 'AGS + BEE', linestyle=line_styles[line_style_index])
        line_style_index += 1

        # if(not isEasy):
        plt.text(x_list[-1], avg_program_solved_against_evals[lk][-1], avg_program_solved_against_evals[lk][-1], fontsize=8.5)
        # else:
        #     if(lk == "BustleBFS"):
    ...
    for key, value in evaluations_map.items():
        ...
        if key == "ags_bee_search":
            plt.plot(plot_expressions, plot_tasks, label='AGS + BEE', linestyle=line_styles[line_style_index], line_width=2 if line_style_index > max_line_style_index else 1.5)
        else:
            plt.plot(plot_expressions, plot_tasks, label='BEE', linestyle=line_styles[line_style_index], line_width=2 if line_style_index > max_line_style_index else 1.5)
        line_style_index += 1

        # if(not isEasy):
        plt.text(plot_expressions[-1] + 1, plot_tasks[-1], plot_tasks[-2], fontsize=8.5)
        # else:
        #     if(key == "BUS"):
    ...
    plt.title("Successes by expressions considered (38B)")
    ...
    for lk in logkeys:
        ...
        plt.step(x_list_time, avg_program_solved_against_time[lk], label='BEE' if lk == 'bee_search' else 'AGS + BEE', linestyle=line_styles[line_style_index])
        line_style_index += 1

        # if(not isEasy):
        plt.text(x_list_time[-1], avg_program_solved_against_time[lk][-1], avg_program_solved_against_time[lk][-1], fontsize=8.5)
        # else:
        #     if(lk == "BustleBFS"):
    ...
    for key, value in times_map.items():
        ...
        plot_tasks = tasks
        if key == "ags_bee_search":
            plt.plot(plot_times, plot_tasks, label='AGS + BEE', where='pre', linestyle=line_styles[line_style_index], line_width=2 if line_style_index > max_line_style_index else 1.5)
        else:
            plt.plot(plot_times, plot_tasks, label='BEE', where='pre', linestyle=line_styles[line_style_index], line_width=2 if line_style_index > max_line_style_index else 1.5)
        line_style_index += 1

        # if(not isEasy):
        plt.text(plot_times[-1] + 1, plot_tasks[-1], plot_tasks[-2], fontsize=8.5)
        # else:
        #     if(key == "BUS"):
    ...
    plt.title("Successes by time considered (38B)")
    plt.grid(True)
