...
if __name__ == "__main__":
    ...
    logs = ["A-Bustle.log", "Bustle.log"]
    logkeys = ["A-Bustle", "Bustle"]
    ...
    for lk in logkeys:
        ...
        final_combined_dataframe_eval[ lk + "_avg"] = avg_prog_solved
        final_combined_dataframe_eval[ lk + "_std"] = std_prog_solved

    print(avg_program_solved_against_evals)
    print(std_programs_solved_against_evals)
    print(final_combined_dataframe_eval.head())
    final_combined_dataframe_eval.to_csv(source_directory + "/" + "SyGuS_A-Bustle_Bustle_evaluations_statistics.csv", index=False)
    '''
    # Plot the data
    for lk in logkeys:
        # axis_fill
        ...
        plt.step(x_list, avg_program_solved_against_evals[lk], label='Bee (82)' if lk == 'Bee_search' else 'A-Bee (88)', linestyle=line_styles[line_style_index])
        line_style_index += 1
    ...
    for lk in logkeys:
        ...
        final_combined_dataframe_time[ lk + "_avg"] = avg_prog_solved
        final_combined_dataframe_time[ lk + "_std"] = std_prog_solved

    print(avg_program_solved_against_time)
    print(std_programs_solved_against_time)
    print(final_combined_dataframe_time.head())
    final_combined_dataframe_time.to_csv(source_directory + "/" + "SyGuS_A-Bustle_Bustle_times_statistics.csv", index=False)
    ...
    for lk in logkeys:
        ...
        plt.step(x_list_time, avg_program_solved_against_time[lk], label='Bee (82)' if lk == 'Bee_search' else 'A-Bee (88)', linestyle=line_styles[line_style_index])
        line_style_index += 1
