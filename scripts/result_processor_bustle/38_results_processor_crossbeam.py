...
if __name__ == "__main__":
    ...
    crossbeam_eval_stats = crossbeam_consolidator.get_evaluation_stats_38b(evaluation_limit)
    ...
    crossbeam_time_stats = crossbeam_consolidator.get_time_stats_38b(time_limit)
    ...
    all_logs = ["BUS_Augmented_38B.log", "BUSTLE_38B.log",
                "BUSTLE_Augmented_38B.log",
                "BUS_38B.log",
                "BUS_Augmented_Combination_38B.log",
                "BUSTLE_Augmented_Combination_38B.log",
                "BUS_Augmented_Chopping_38B.log",
                "BUSTLE_Augmented_Chopping_38B.log"
                # , "crossbeam.log"
                ]

    logs = all_logs

    all_logkeys = ["AGS", "BUSTLE", "AGS+BUSTLE", "BUS", "BUS+COMB",
                   "BUSTLE+COMB", "BUS+CHOP", "BUSTLE+CHOP"
                   # , "crossbeam"
                   ]
    ...
    statkeys = ["AGS", "BUSTLE", "AGS+BUSTLE", "BUS", "BUS+COMB",
                "BUSTLE+COMB", "BUS+CHOP", "BUSTLE+CHOP"
                # , "crossbeam"
                ]
    ...
    plt.savefig("./result_images/max_expr_38b.png", bbox_inches='tight')
    plt.show()
    plt.close()
    ...
    plt.title("Successes by expressions considered (38B)")
    plt.grid("on", linestyle=':')
    plt.savefig("./result_images/max_time_38b.png", bbox_inches='tight')
    plt.show()
    plt.close()
